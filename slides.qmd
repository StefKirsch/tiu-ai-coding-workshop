...
The **prompt** is what you add to the context to create the next piece of output. The **output** (completion) is the model’s response generated from that prompt.
...
![](https://miro.medium.com/v2/resize:fit:1100/format:webp/1*clU4bA8DttJiyPnrRBVLWw.png){width="30%"} 
![](https://i.ytimg.com/vi/oB4JR98KRAA/mqdefault.jpg){width="30%"}
...
## Pitfall 4a: Balancing privacy and efficiency

Look up specific packages that are able to accomplish your task before completely pinning it on ChatGPT.

![](https://i.imgflip.com/a5je7z.jpg){width="500" style="max-height:unset;"}

## Pitfall 4b: Balancing privacy and efficiency

Use-case: Researcher wants to find the distance between some addresses from collected data (potentially sensitive)

Solutions:

❌Feed all addresses into ChatGPT and ask it to compute the distances.

✅ Use `geompy`, a python package that makes it very easy to locate the coordinates of addresses, cities, countries and landmarks across the globe.
...
>>> location2 = geolocator.geocode("99 5th Avenue NYC")
>>> print(geodesic(location1, location2).miles)
```
...
<iframe 
src="https://giphy.com/embed/KyGiMJokZEQvu" width="480" height="269" style frameBorder="0" class="giphy-embed" allowFullScreen>
