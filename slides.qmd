...
- Model choice
- Iterate on prompts
- Lots of control (including which data you enter)\
→ *GDPR compliance*
...
Even if found online, personal data should not be entered into cloud-based (AI) systems.
:::
...
Examples are: Windsurf, GitHub Copilot, Claude Code, Cursor and other Agentic development tools.
:::
