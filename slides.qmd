...
For longer, real‑life chats it’s often more useful to not think in prompts, but it the full **context**. The context is the full window of tokens the model can “see”, i.e. the chat history plus anthing else the LLM provider adds to the context.
