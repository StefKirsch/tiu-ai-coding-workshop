...
::: {.center-middle}
![](images/non-reasoning.png){width="1000" style="max-height:unset;" fig-align="center"}
:::


## 🤔 Plain LLM VS Reasoning Models {.no-scroll}

![](images/reasoning.png){width="1000" style="max-height:unset;" fig-align="center"}
...
![Photo by Levart_Photographer on Unsplash](images/levart_photographer-drwpcjkvxuU-unsplash.jpg)
:::
:::
...
-   Vast experience in nearly every technology... kind of...
...
Is AI really that special?
:::

::: {.column width="60%"}
![Photo by NASA on Unsplash](images/nasa-Q1p7bh3SHj8-unsplash.jpg)
:::
...
1. Work with metadata (column names, number of rows, aggregated data, ...)
2. Synthetic data
3. Specialized packages that run locally or in a protected cloud 
4. Local AI models (e.g. JanAI)
...
::: column
![Photo by Jen Theodore on Unsplash](images/jen-theodore-tWqyWrqLntU-unsplash.jpg){width="80%" fig-align="center"}
:::
...
![](images/chatgpt_meditation.png){fig-align="center"}

## 🐛 Beware of bugs

AI produces overly eager results without really thinking them all the way through.

![](images/chatgpt_meditation2.png){fig-align="center"}
...
![](images/GPT5_understand_code_2.png){width="900" style="max-height:unset;" fig-align="center"}

## 🏁 Asking for feedback

\

![](images/GPT5_understand_code_3.png){fig-align="center"}

## 🏁 Asking for feedback

\

![](images/GPT5_understand_code_4.png){width="900" style="max-height:unset;" fig-align="center"}
